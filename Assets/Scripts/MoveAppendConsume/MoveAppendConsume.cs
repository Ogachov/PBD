...
{
    public class MoveAppendConsume : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _particleBuffer = new GraphicsBuffer(GraphicsBuffer.Target.Structured, numParticles, sizeof(float) * 7);
        ...
        private void Update()
        {
            ...
            // Spawn
            {
                ...
                if (spawnCount > 0)
                {
                    ...
                    computeShader.SetBuffer(k_SpawnParticles, "AliveList", _activeBuffer);
